        ...
        for ( var i =0; i<urls.length; i++){
            ...
            if (split[1] != null){
                ...
                if ( !used_urls.has(urls[i]) && firstChar >= '0' && firstChar <='9'){    
                    ...
                    // document.querySelectorAll('div[id="location-schools"] > div[class="media-block"]  > div[class="media-heading"]');
                    ...
                    for (var e =0 ;e < schoolRatings.length; e ++){
                        t.push(allSchoolType[allSchoolType.length - schoolRatings.length -1 + e]);
                        t2.push(allSchoolDis[allSchoolDis.length - schoolRatings.length -1 + e]);
                    }
                    allSchoolType = t;
                    allSchoolDis = t2;
                    ...
                    // make sum function here. ...puppeteer.connect.apply.call.
                    // for (var e =0; e <schoolRatings.length; e++){
